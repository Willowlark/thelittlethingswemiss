...
<!-- 
def mid(tn, r, s1, s2):
    print(f"Total per night: {tn}")
    print("Room | Split | Per Night |")
    for i in range(s1, s2+1):
        print(f"{r}    | {i}{'     ' if i < 10 else '    '}| {round((tn*r)/i,2)}     |")
 -->
...
Base Info    | One Room | Two Rooms | Three Rooms
-------------|----------|-----------|------------
Total:       | $479.52  | $959.4    | $1438.56
Total/Night: | $159.84  | $319.68   | $479.52
Room/Night:  | $144     | $144      | $144
Tax/Night:   | 11%      | 11%       | 11%
Rooms:       | 1        | 2         | 3
Nights:      | 3        | 3         | 3
...
-------------|--------------|-----------
Total:       | $699.0       | $1398
Total/Night: | $233.0       | $466.00
Room/Night:  | $200         | $400
Tax/Night:   | 14.75% + 3.5 | 14.75% + 7
Rooms:       | 1            | 2
Nights:      | 3            | 3
